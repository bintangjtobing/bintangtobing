                ...
                <div class="site-nav">
                    <nav role="navigation">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#organizations" title="Organizations"><span
                                        class="menu-title">Organizations</span></a>
                            </li>
                ...
                <div class="shadow-1-strong bg-white my-5" id="intro" style="border-radius: .35rem;">
                    <div class="bg-info text-white">
                        <div class="cover bg-image"><img
                            ...
                            <div class="mask" style="background-color: rgba(0, 0, 0, 0.3);backdrop-filter: blur(5px);">
                        ...
                        <div class="timeline">
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '15-05-2021'; $bciAge = Carbon::parse($bciStart)->diff(Carbon::now())->format('%y yrs, %m mos');?>
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '01-03-2019'; $bciAge = Carbon::parse($bciStart)->diff('31-07-2022')->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($bciStart)->isoFormat('MMM YYYY')}} -
                                        {{Carbon::parse('31-07-2022')->isoFormat('MMM YYYY')}} · {{$bciAge}}
                                    </div>
                                    <div>
                                        <p align="justify">
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '01-12-2020'; $bciAge = Carbon::parse($bciStart)->diff('01-02-2021')->format('%m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($bciStart)->isoFormat('MMM YYYY')}} -
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '18-09-2018'; $bciAge = Carbon::parse($bciStart)->diff('01-05-2019')->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($bciStart)->isoFormat('MMM YYYY')}} -
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '01-09-2017'; $bciAge = Carbon::parse($bciStart)->diff('01-08-2018')->format('%m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($bciStart)->isoFormat('MMM YYYY')}} -
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $bciStart = '01-03-2017'; $bciAge = Carbon::parse($bciStart)->diff('01-09-2017')->format('%m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($bciStart)->isoFormat('MMM YYYY')}} -
                    ...
                    <div class="education-section">
                        ...
                        <div class="timeline">
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $eduStart = '10-08-2019'; $eduAge = Carbon::parse($eduStart)->diff(Carbon::now())->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $eduStart = '01-06-2013'; $eduAge = Carbon::parse($eduStart)->diff('01-06-2016')->format('%y yrs');?>
                                    <div class="text-muted text-small mb-3">
                    ...
                    <div class="work-experience-section">
                        ...
                        <div class="timeline">
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $orgStart = '10-07-2019'; $orgEnd = Carbon::parse($orgStart)->diff('10-07-2020')->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $orgStart = '10-04-2017'; $orgEnd = Carbon::parse($orgStart)->diff('10-05-2020')->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($orgStart)->isoFormat('MMM YYYY')}} -
                            ...
                            <div class="timeline-card timeline-card-disabled" data-aos="fade-in" data-aos-delay="0">
                                ...
                                <div class="timeline-body px-4 pb-4">
                                    <?php $orgStart = '10-04-2015'; $orgEnd = Carbon::parse($orgStart)->diff('10-06-2017')->format('%y yrs, %m mos');?>
                                    <div class="text-muted text-small mb-3">
                                        {{Carbon::parse($orgStart)->isoFormat('MMM YYYY')}} -
